...
namespace HMS {
    ...
    public class froentoffice : ReportClass {
    ...
    public class Cachedfroentoffice : Component, ICachedReport {
        
        public Cachedfroentoffice() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            froentoffice rpt = new froentoffice();
            rpt.Site = this.Site;
            return rpt;
        }
